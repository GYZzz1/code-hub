package com.gyzjc.subject.infra.basic.service.impl;

import com.gyzjc.subject.infra.basic.entity.SubjectRadio;
import com.gyzjc.subject.infra.basic.dao.SubjectRadioDao;
...
public class SubjectRadioServiceImpl implements SubjectRadioService {
     ...
     */
    @Override
    public void batchInsert(List<SubjectRadio> subjectRadios) {
        this.subjectRadioDao.insertBatch(subjectRadios);
    }
